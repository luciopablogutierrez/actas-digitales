...
export const councilMembers: CouncilMember[] = [
  { id: 'cm1', name: 'Alejandro Coria', party: 'Potencia', avatarUrl: 'https://i.pravatar.cc/150?u=cm1_new', attendance: [{ sessionId: 's1', present: true }, { sessionId: 's2', present: true }, { sessionId: 's-live', present: true }] },
