...
export const councilMembers: CouncilMember[] = [
  ...
  { id: 'cm3', name: 'Marta Pérez', party: 'Unión por el Futuro', avatarUrl: 'https://i.pravatar.cc/150?u=cm3', attendance: [{ sessionId: 's1', present: true }, { sessionId: 's2', present: true }, { sessionId: 's-live', present: false }] },
  ...
  { id: 'cm5', name: 'Laura Martinez', party: 'Frente Renovador', avatarUrl: 'https://i.pravatar.cc/150?u=cm5', attendance: [{ sessionId: 's1', present: true }, { sessionId: 's2', present: true }, { sessionId: 's-live', present: true }] },
...
export const topics: Topic[] = [
  ...
  { id: 't5', fileNumber: 'EXP-2024-105', title: 'Regulación de Food Trucks', presenter: 'Carlos Rodríguez', result: 'Pendiente', summary: 'Se está evaluando una nueva ordenanza para regular la ubicación, horarios y requisitos sanitarios para los camiones de comida en la vía pública.' },
];
